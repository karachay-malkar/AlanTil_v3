(function () {
  ...
  // --- Close dictionary content first if opened
  if (viewDictContent && !viewDictContent.classList.contains("hidden")) {
    viewDictContent.classList.add("hidden");
    return;
  }
  ...
  if (btnOpenDictContent && viewDictContent) {
    btnOpenDictContent.addEventListener("click", () => {
      renderDictContent("");
      viewDictContent.classList.remove("hidden");
      if (dictSearchInput) {
